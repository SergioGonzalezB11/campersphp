...
<body>
    <div class="container mt-4">
        <form method="POST" action="formpost.php" id="frmData" class="m-6 border border-5 rounded border-info p-3">
            <div class="row pb-3">
                <div class="col-6">
                    <div class="mb-3">
            ...
            <div class="row p-3">
                ...
                <div class="col-6">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" name="lenguajes[]" id="flexCheckDefault">
